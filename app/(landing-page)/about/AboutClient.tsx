        ...
        <div className="relative flex items-center bg-white/95 backdrop-blur-md rounded-full shadow-xl border border-slate-200 p-1">
          ...
          {(['en', 'hi'] as Lang[]).map((option) => (
            <button
              ...
              className={`relative z-10 px-3.5 py-2 text-xs sm:text-sm font-bold rounded-full transition-colors ${lang === option ? 'text-white' : 'text-slate-600 hover:text-slate-900'
                }`}
            >
              {lang === option && (
                <motion.span
        ...
        >
          ...
          <section className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
                <Reveal className="relative h-80 lg:h-115 rounded-md overflow-hidden mb-10 lg:mb-0">
                  <Image
                  ...
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-32 h-3 bg-black/30 blur-md rounded-[50%]" />
                </Reveal>
                <Reveal delay={0.15}>
                  <div>
                    <div className="inline-flex items-center space-x-2 bg-orange-50 px-4 py-2 rounded-md text-orange-700 font-medium text-sm mb-6">
          ...
          <section className="py-16 bg-slate-50">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <div className="inline-flex items-center space-x-2 bg-green-50 px-4 py-2 rounded-md text-green-700 font-medium text-sm mb-6">
          ...
          <section className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 mb-14">
                {INFRASTRUCTURE.map((item, i) => (
                  <motion.div
                    ...
                    className="bg-white border border-slate-200/70 rounded-md p-5 hover:shadow-lg flex flex-col items-center text-center gap-3"
                  >
                    <motion.span
                      animate={{ scale: [1, 1.08, 1] }}
                      transition={{ duration: 2.4, repeat: Infinity, delay: i * 0.3 }}
                      className={`w-12 h-12 rounded-md flex items-center justify-center ${item.bg}`}
                    >
              ...
              <div className="max-w-2xl mx-auto mb-14  rounded-md  p-6">
                <MilkMachine className="w-full h-auto" />
                                <div className="relative bottom-8 my-4 left-1/2 -translate-x-1/2  w-96 h-3 bg-black/30 blur-md rounded-[50%]" />
              </div>
          ...
          <section className="py-16 bg-orange-50/40">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <div className="inline-flex items-center space-x-2 bg-white px-4 py-2 rounded-md text-orange-700 font-medium text-sm mmd ">
          ...
          <section className="py-16 bg-slate-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <Reveal delay={0}>
                  <motion.div whileHover={{ y: -8, rotate: -1.5 }} transition={{ type: 'spring', stiffness: 250, damping: 18 }} className="bg-white p-7 rounded-md  hover:shadow-xl border border-slate-200/60 flex flex-col items-center text-center h-full">
                    <div className="w-16 h-16 bg-orange-100 text-orange-600 rounded-md flex items-center justify-center mb-6">
                ...
                <Reveal delay={0.12}>
                  <motion.div whileHover={{ y: -8, rotate: 1.5 }} transition={{ type: 'spring', stiffness: 250, damping: 18 }} className="bg-white p-7 rounded-md  hover:shadow-xl border border-slate-200/60 flex flex-col items-center text-center h-full">
                    <div className="w-16 h-16 bg-green-100 text-green-600 rounded-md flex items-center justify-center mb-6">
              ...
              <div className="grid sm:grid-cols-3 gap-6">
                {products.map((p, i) => (
                  <Reveal key={p.name} delay={i * 0.1}>
                    <div className="bg-slate-50 rounded-md border border-slate-100 p-6 h-full flex flex-col items-center text-center">
          ...
          <section className="py-16 bg-slate-50">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <Reveal delay={0}>
                  <motion.div whileHover={{ y: -6 }} className="bg-white p-8 rounded-md  border border-slate-200/60 flex flex-col items-center text-center h-full">
